...
router.get('/blue/:id', (req, res) => {
  ...
  const queryText = `SELECT "blue_forces".id AS "id", "unit_id", "units"."type" AS "type",  "quantity", "strength", "units".country_code AS "country_code", "fe" FROM "blue_forces"
...
router.get('/red/:id', (req, res) => {
  ...
  const queryText = `SELECT "red_forces".id AS "id", "unit_id", "units"."type" AS "type",  "quantity", "strength", "units".country_code AS "country_code", "fe" FROM "red_forces"
