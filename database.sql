...
CREATE TABLE IF NOT EXISTS "equation_coefficients" (
	...
	"base" float8 NOT NULL DEFAULT 0,
	"exponent" float8 NOT NULL DEFAULT 0,
	PRIMARY KEY ("id")
);
...
CREATE TABLE IF NOT EXISTS "missions_equtions" (
	"id" serial NOT NULL UNIQUE,
...
ALTER TABLE "missions_equtions" ADD CONSTRAINT "missions_equtions_fk1" FOREIGN KEY ("mission_id") REFERENCES "missions"("id");
ALTER TABLE "missions_equtions" ADD CONSTRAINT "missions_equtions_fk2" FOREIGN KEY ("equation_id") REFERENCES "equation_coefficients"("id");